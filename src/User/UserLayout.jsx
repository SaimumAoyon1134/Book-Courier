      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content">
          ...
          <nav className="navbar w-full  flex justify-between bg-[#68ba11] ">
            ...
            <div className="px-4 items-center flex justify-center"><h1 className="text-2xl font-extrabold  text-center">User Dashboard</h1></div>
            <ThemeToggle/>
          </nav>
            ...
            <ul className="menu w-full grow pt-15  font-bold ">
              ...
              <li>
               ...
               <li>
                ...
                >
                  <FavoriteIcon className="my-1.5 inline-block size-4" />
                  <span className="is-drawer-close:hidden">My Wish List</span>
                   ...
                   <li>
                    ...
                    data-tip="Invoices"
                    >
                    < InfoIcon className="my-1.5 inline-block size-4" />
