  ...
  return (
    <div className="px-3 md:px-15">
      <h1 className="text-center text-xl font-bold">
        <ScheduleIcon className="animate-spin [animation-duration:5s] text-[#748603]" />{" "}
        <span className="text-[#f75408]">Latest Books </span>
      </h1>
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 my-5">
        {latestBooks.map((book) => (
          <div
            ...
            className="shadow-md shadow-green-500/40 p-2 rounded-lg flex flex-col items-center"
          >
            <img
              src={book.image}
              alt={book.name}
