...
const Latest = () => {
  ...
  return (
    <div className='px-1 md:px-10'>
        <h1 className='text-center font-bold'><ScheduleIcon className='animate-spin [animation-duration:5s] text-[#748603]'/> <span className='text-[#f75408]'>Latest Books </span></h1>
        <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 my-5'>
            {
                latestBooks.map((book)=>(
                    <div key={book._id} className='border p-2 rounded-lg flex flex-col items-center'>
